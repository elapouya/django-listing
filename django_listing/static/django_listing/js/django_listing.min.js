...
function djlst_unique_row_select(a){a=$(this).closest(".row-container");a.siblings().removeClass("selected").find("input.row-select").removeAttr("name");var b=a.find("input.row-select").first();a.addClass("selected");b.attr("name",b.attr("select-name"));a.find("input.selection-box").first().prop("checked",!0)}
