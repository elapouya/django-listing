...
function djlst_load_listing_url(a,b,c){null===b&&(b=djlst_get_requested_url(a));var d=djlst_extract_params_from_url(b,["variation"]);0<Object.keys(d).length&&(c=c?Object.assign({},c,d):d);$("div.django-listing-ajax").length||(window.location.href=b);const e=a.closest("div.django-listing-ajax");e.addClass("spinning");d=$(e).attr("id");const f=$(`form[listing-id=${d}]`),g=$(e).attr("listing-suffix");let h=a.attr("listing-target");h||(h="#"+d);let k=a.attr("listing-part");k||(k="all");d={listing_id:d,
