...
'"]');c.find("button.all-count span.button-extra-middle").html(b);"0"===a?c.find("button.all-count").addClass("disabled"):c.find("button.all-count").removeClass("disabled")})}function djlst_follow_file_generation(){"done"!==Cookies.get("file_generation")?setTimeout(djlst_follow_file_generation,300):(Cookies.remove("file_generation"),$(".spinning").removeClass("spinning").addClass("done"))}
