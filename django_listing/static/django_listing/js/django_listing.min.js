...
function djlst_load_listing_url(a,b,c){null===b&&(b=djlst_get_requested_url(a));$("div.django-listing-ajax").length||(window.location.href=b);const d=a.closest("div.django-listing-ajax");d.addClass("spinning");var e=$(d).attr("id");const f=$(`form[listing-id=${e}]`),g=$(d).attr("listing-suffix");let h=a.attr("listing-target");h||(h="#"+e);let k=a.attr("listing-part");k||(k="all");e={listing_id:e,listing_suffix:g,listing_part:k};e=djlst_add_filter_request_data(d,a,e);c&&(e=Object.assign({},e,c));update_csrf_token();
$.ajax({type:"POST",url:b,data:e,success:function(l){l.filters_form&&(f.replaceWith(l.filters_form),d.removeClass("spinning"));l.listing&&(d.replaceWith(l.listing),djlst_listing_on_load(),$(document).trigger("djlst_ajax_loaded",{listing_target:h,response:l.listing}))},error:function(l){text="An error occured.\n\nIndications :\n\n"+l.responseText;alert(text)}});return!1}function djlst_load_listing_href(){return djlst_load_listing_url($(this),$(this).attr("href"))}
