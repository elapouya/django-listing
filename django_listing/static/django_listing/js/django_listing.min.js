...
$(document.body).on("click",".apply-group-by",function(){djlst_load_listing_url($(this),null)});$(document.body).on("click",".remove-group-by",function(){$(this).closest("div.django-listing-ajax").find(".group-by-container select").val("");djlst_load_listing_url($(this),null)});$('[data-toggle="popover"]').popover();var c=0;$(".dropzone").on("dragenter",function(){c++;$(this).addClass("drag-over")});$(".dropzone").bind("dragleave",function(){c--;0===c&&$(this).removeClass("drag-over")});$(".dropzone").bind("drop",
function(){c=0;$(this).removeClass("drag-over")});$(document.body).on("click",".submit-action-form",function(){var d=$(this).val(),e=$(this).closest(".django-listing-container").find(".action-form");e.find(".action-hidden-value").val(d);e.submit()});$(document).on("select2:open",function(d){d=$(d.target).parent().find(".select2-selection").attr("aria-owns");document.querySelector('input[aria-controls="'+d+'"]')&&(document.querySelector('input[aria-controls="'+d+'"]').focus(),b=!0)});$("form").keyup(function(d){9==
d.keyCode&&(d=$(d.target),d.hasClass("select2-selection")?(b||d.closest(".select2").siblings("select").first().select2("open"),b=!0):b=!1)});$(document.body).on("click",".file-generation-button",function(){var d=$(this),e=$(this).siblings("select");if(e.length&&!e.val())return(e=$(this).data("empty-select-msg"))||(e="Please select a value !"),alert(e),!1;e=$(this).closest("form");var f=e.closest(".django-listing-container");f=djlst_add_filter_request_data(f,d,{});d=djlst_get_requested_url(d).split("?")[1];
