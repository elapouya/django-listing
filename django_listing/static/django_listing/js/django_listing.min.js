...
$jscomp.polyfill("Object.fromEntries",function(a){return a?a:function(b){var c={};if(!(Symbol.iterator in b))throw new TypeError(""+b+" is not iterable");b=b[Symbol.iterator].call(b);for(var d=b.next();!d.done;d=b.next()){d=d.value;if(Object(d)!==d)throw new TypeError("iterable for fromEntries should yield objects");c[d[0]]=d[1]}return c}},"es_2019","es3");$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
...
function djlst_merge_form_data(a,b){a=Object.fromEntries(a.entries());b=Object.assign({},a,b);a=new FormData;for(let [c,d]of Object.entries(b))a.append(c,d);return a}
function djlst_load_listing_url(a,b){$("div.django-listing-ajax").length||(window.location.href=b);var c=a.closest("div.django-listing-ajax");c.addClass("spinning");var d=$(c).attr("id");c=$(c).attr("listing-suffix");let e=a.attr("listing-target");e||(e="#"+d);(a=a.attr("listing-part"))||(a="all");a={listing_id:d,listing_suffix:c,listing_part:a};d=$(`form[listing-id=${d}]`);d.length&&(c=d.attr("method"),void 0!==c&&"post"==c.toLowerCase()&&(d=Object.fromEntries(new FormData(d[0])),a=Object.assign({},
a,d)));update_csrf_token();$.ajax({type:"POST",url:b,data:a,success:function(f){$(e).replaceWith(f);djlst_listing_on_load();$(document).trigger("djlst_ajax_loaded",{listing_target:e,response:f})},error:function(f){text="An error occured.\n\nIndications :\n\n"+f.responseText;alert(text)}});return!1}function djlst_load_listing_href(){return djlst_load_listing_url($(this),$(this).attr("href"))}
...
a={listing_id:h,listing_suffix:l,listing_part:n,action:"attached_form",action_button:b,selected_pks:g,serialized_data:a.closest("form").serialize()};update_csrf_token();$.ajax({type:"POST",url:f,data:a,success:function(k){let p;k.listing&&e.replaceWith(k.listing);k.attached_form&&(c.replaceWith(k.attached_form),djlst_selection_changed_hook(e));k.object_pk&&(p=$("#"+d),p.find('input[name="object_pk"]').val(k.object_pk));$(document).trigger("djlst_ajax_attached_form_loaded",{listing:m,form:p,response:k})},
error:function(k){text="An error occured.\n\nIndications :\n\n"+k.responseText;alert(text)}})}var djlst_last_selected_rows_container=null,djlst_last_selected_index=null;
