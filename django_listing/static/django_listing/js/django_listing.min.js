...
function djlst_merge_form_data(a,b){a=Object.fromEntries(a.entries());b=Object.assign({},a,b);a=new FormData;for(let [c,d]of Object.entries(b))a.append(c,d);return a}function djlst_add_filter_request_data(a,b){a=$(`form[listing-id=${a}]`);if(a.length){const c=a.attr("method");void 0!==c&&"post"==c.toLowerCase()&&(a=Object.fromEntries(new FormData(a[0])),b=Object.assign({},b,a))}return b}
