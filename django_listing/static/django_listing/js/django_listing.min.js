...
"Available columns",selectedTitle:b.attr("selected-title")||"Selected columns"});$(this).find(".apply-group-by").on("click",function(){var c=a.val().join(",");c=djlst_replaceUrlParam(window.location.href,"gb_cols",c);let d=b.val().join(",");c=djlst_replaceUrlParam(c,"gb_annotate_cols",d);djlst_load_listing_url($(this),c)})});$(".remove-group-by").on("click",function(){let a=djlst_removeUrlParam(window.location.href,"gb_cols");a=djlst_removeUrlParam(a,"gb_annotate_cols");djlst_load_listing_url($(this),
a)});$(".django-listing-container.format-numbers td.type-Decimal,.django-listing-container.format-numbers td.type-int,.django-listing-container.format-numbers td.type-float").djlst_format_digits()}function djlst_follow_file_generation(){"done"!==Cookies.get("file_generation")?setTimeout(djlst_follow_file_generation,300):(Cookies.remove("file_generation"),$(".spinning").removeClass("spinning").addClass("done"))}
