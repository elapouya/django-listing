...
$(document.body).on("click","li.action-item.view-object-popup a",djlst_view_object_popup);$('[data-toggle="popover"]').popover();var a=0;$(".dropzone").on("dragenter",function(){a++;$(this).addClass("drag-over")});$(".dropzone").bind("dragleave",function(){a--;0===a&&$(this).removeClass("drag-over")});$(".dropzone").bind("drop",function(){a=0;$(this).removeClass("drag-over")});$(".submit-action-form").on("click",function(){var b=$(this).val(),c=$(this).closest(".django-listing-container").find(".action-form");
c.find(".action-hidden-value").val(b);c.submit()})});
