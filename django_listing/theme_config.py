...
class ThemeConfigBase(metaclass=ThemeConfigMeta):
    ...
    attached_form_delete_all_button_class = "attached-form-nav btn btn-primary submit-button all-count"
    attached_form_delete_button_class = "attached-form-nav btn btn-primary submit-button disabled-if-no-selection selected-count"
    ...
    attached_form_update_button_class = "attached-form-nav btn btn-primary submit-button disabled-if-no-selection selected-count"
    attached_form_update_all_button_class = "attached-form-nav btn btn-primary submit-button all-count"
