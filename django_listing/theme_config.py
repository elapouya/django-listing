...
class ThemeConfigBase(metaclass=ThemeConfigMeta):
    ...
    attached_form_delete_button_class = "attached-form-nav btn btn-primary submit-button selected-count"
    ...
    attached_form_update_button_class = "attached-form-nav btn btn-primary submit-button selected-count"
