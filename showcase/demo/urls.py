...
urlpatterns = i18n_patterns(
    ...
    path("readme/3/", ReadMe3View.as_view(), name="readme3"),
    path("readme/4/", ReadMe4View.as_view(), name="readme4"),
    path("readme/5/", ReadMe5View.as_view(), name="readme5"),
    path("basic_usage/", BasicUsageListingView.as_view(), name="basic_usage"),
    path("many_ways/", ManyWaysListingView.as_view(), name="many_ways"),
