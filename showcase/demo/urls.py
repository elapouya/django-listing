...
urlpatterns = i18n_patterns(
    ...
    path("ref_guide/10/", RefGuide10View.as_view(), name="ref_guide10"),
    path("ref_guide/11/", RefGuide11View.as_view(), name="ref_guide11"),
    ...
    path("ref_guide/16/", RefGuide16View.as_view(), name="ref_guide16"),
