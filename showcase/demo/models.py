...
from django_better_image.fields import BetterImageField, BetterImageOriginalField
...
class Employee(models.Model):
    ...
    gender = models.CharField(
        max_length=10, verbose_name=_("Gender"), choices=GENDER_CHOICES
    )
    marital_status = models.CharField(
        max_length=10, verbose_name=_("Marital status"), choices=MARITAL_STATUS_CHOICES
    )
