...
class RefGuide3View(TemplateView):
    template_name = "demo/ref_guide/ref_guide3.html"


class RefGuide4View(TemplateView):
    template_name = "demo/ref_guide/ref_guide4.html"


class RefGuide5View(TemplateView):
    template_name = "demo/ref_guide/ref_guide5.html"


class RefGuide6View(TemplateView):
    template_name = "demo/ref_guide/ref_guide6.html"


class RefGuide7View(TemplateView):
    template_name = "demo/ref_guide/ref_guide7.html"


class RefGuide8View(TemplateView):
    template_name = "demo/ref_guide/ref_guide8.html"


class RefGuide9View(TemplateView):
    template_name = "demo/ref_guide/ref_guide9.html"


class RefGuide10View(TemplateView):
    template_name = "demo/ref_guide/ref_guide10.html"


class RefGuide11View(TemplateView):
    template_name = "demo/ref_guide/ref_guide11.html"


class RefGuide12View(TemplateView):
    template_name = "demo/ref_guide/ref_guide12.html"


class RefGuide13View(TemplateView):
    template_name = "demo/ref_guide/ref_guide13.html"


class RefGuide14View(TemplateView):
    template_name = "demo/ref_guide/ref_guide14.html"


class RefGuide15View(TemplateView):
