...
project = u'django-listing'
copyright = u'2018, Eric Lapouyade'
...
pdf_documents = [('index', u'django-listing_pdf', u'django-listing', u'Eric Lapouyade'),]
...
latex_documents = [
  ('index', 'django-listing.tex', u'django-listing Documentation',
...
man_pages = [
    ('index', 'django-listing', u'django-listing Documentation',
     [u'Eric Lapouyade'], 1)
]
...
texinfo_documents = [
  ('index', 'django-listing', u'django-listing Documentation',
   u'Eric Lapouyade', 'best-templatetags', 'django-listing library.',
   'Miscellaneous'),
]
